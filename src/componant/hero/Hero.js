  ...
  return (
   <div className="hero-parent parent">
    ...
    <div className="hero-left">
      ...
      <p className='hero-desc'>Roast coffee with aviation precision. Roast coffee with aviation precision. Roast coffee with aviation precision.</p>
      ...
      <div className="box">
      <div className="number">5k <span>+</span></div>
      <div className="descs">HAPPY CUSTOMER</div>
      </div>
      </div>
    </div>
    <div className="hero-right bg-img-contain">
